        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="进货单号" prop="poCode">
              <el-input v-model="purchaseOrderInf.poCode" placeholder="自动获取系统编号" readonly
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="供应商" prop="sId">
              <el-select v-model="purchaseOrderInf.sId" placeholder="请选择供应商">
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      this.$refs.purchaseOrderInf.validate((valid) => {
        if (valid) {
      ...
      console.log("purchaseOrderInf: ", this.purchaseOrderInf)
    },
